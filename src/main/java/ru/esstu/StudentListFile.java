...
public class StudentListFile implements StudentList {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(file))) {
            ...
            while ((line = reader.readLine()) != null) {
                if (line.startsWith("ID:")) {
                    ...
                    middleName = line.substring(17).trim();
                } else if (line.startsWith("Group:")) {
                    group = line.substring(7).trim();
                }
            }

            if (id != null && firstName != null && lastName != null && middleName != null && group != null) {
                return new Student(id, firstName, lastName, middleName, group);
            }
        } catch (IOException e) {
    ...
    private void saveToFile(Student student) {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(fileName))) {
            ...
            writer.newLine();
            writer.write("Middle Name: " + student.getMiddleName());
            writer.newLine();
